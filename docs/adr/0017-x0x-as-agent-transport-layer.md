...
- **Mechanics:** Agent-transport implementation status and alternatives record are maintained in [`docs/design/adr-0017-mechanics.md`](../design/adr-0017-mechanics.md) (extracted 2026-08-29; ADR body unchanged)
