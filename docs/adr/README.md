...
- [ADR 0051: Peer Relay (X0X-0070) Is a Default-Off, One-Hop DM Fallback](./0051-application-level-peer-relay.md) (proposed 2026-08-29) — ML-DSA-signed `RelayHeader` wrapping an immutable `DmEnvelope` verbatim, one hop; policy default disabled, contact-required, rate/byte caps; first-eligible selection pending ADR-0035's spread model
