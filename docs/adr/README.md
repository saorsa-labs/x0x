...
- [ADR 0071: Relay Backbone — What Relays Today and What Is Deferred](./0071-relay-backbone-shipped-truth-and-deferred-work.md) (proposed 2026-09-25) — **amends ADR 0020 and ADR 0035**; records shipped relaying (ant-quic MASQUE used via advertised bootstrap/`--relay`/proven-public nodes; Leaf desktops don't forward gossip; peer relay default-off) and freezes ADR 0035 steps 2–6 and ADR 0051 promotion until #807/#731 close with fleet evidence; #132 relayed-forward proof still owed
- [ADR 0072: Scope Freeze — Deferred and Legacy-Maintenance Mechanisms](./0072-scope-freeze-deferred-and-legacy-maintenance.md) (proposed 2026-09-25) — **amends ADR 0010, 0037, 0038, 0043, 0063**; roaming/key-move deferred (ceremony off, ≥1-Roaming requirement suspended), GSS legacy-maintenance (still the plane for `public_request_secure`), ADR 0063 frozen at current gates, Home/fork-quarantine no new features; new ADRs must name the vision requirement (R1–R11) they serve
