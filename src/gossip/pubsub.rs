...
mod tests {
    ...
    async fn lazy_peer_beyond_degree_recovers_publish_via_real_ihave_iwant() {
        ...
        receiver.handle_incoming(PeerId::new([9; 32]), ihave).await;
