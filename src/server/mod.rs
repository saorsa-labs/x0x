...
use routes::{
    ...
    connect_agent, connect_diagnostics_handler, connect_machine, create_task_list,
    delete_contact, delete_machine, direct_connections, direct_message_send_config,
    direct_send, discovered_machine, discovered_machines, exec_cancel, exec_diagnostics,
