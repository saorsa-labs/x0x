...
use routes::{
    add_contact, add_machine, add_task, agent_info, agent_reachability, agent_sign,
    agent_user_id_handler, agent_verify, agents_by_user_handler, announce_identity,
    apply_upgrade, broadcast_current_manifest, check_upgrade, connect_agent,
    connect_diagnostics_handler, connect_machine, create_task_list, delete_contact,
    delete_machine, direct_connections, direct_message_send_config, direct_send,
    discovered_agent, discovered_agents, discovered_machine, discovered_machines, exec_cancel,
    ...
    get_constitution_json, handle_file_message, health, identity_revocations, identity_revoke,
    ...
    pin_machine, populate_invite_base_state_from_group_info, presence, presence_find,
    presence_foaf, presence_online, presence_status, quick_trust, revoke_contact,
