...
6. **CRDT** (`crdt/`): Collaborative task lists with OR-Set checkboxes (Empty/Claimed/Done), LWW-Register metadata, LWW-Register ordering (no RGA). Deltas can be encrypted via MLS groups.
